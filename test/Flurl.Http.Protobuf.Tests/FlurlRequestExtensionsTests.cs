...
namespace Flurl.Http.Protobuf.Tests
{
    public class FlurlRequestExtensionsTests
    {
        ...
        public async Task GetProtobufAsync_SimpleObject()
        {
            ...
            {
                var result = await new FlurlRequest("https://some.url").WithClient(client).GetProtobufAsync<SimpleModel>();
        ...
        public void PostProtobufAsync_WithoutProtocontract()
        {
            ...
            Assert.ThrowsAsync<InvalidOperationException>(() => new FlurlRequest("https://some.url").PostProtobufAsync(obj));
        ...
        public async Task GetProtobufAsync_ComplexObject()
        {
            ...
            var result = await new FlurlRequest("https://some.url").GetProtobufAsync<ComplexObject>();
