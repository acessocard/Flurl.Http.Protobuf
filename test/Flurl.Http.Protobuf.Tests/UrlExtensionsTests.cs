...
namespace Flurl.Http.Protobuf.Tests
{
    ...
    public class UrlExtensionsTests
    {
        ...
        public async Task GetProtobufAsync_SimpleObject()
        {
            ...
            {
                var result = await new Url("https://some.url").WithClient(client).GetProtobufAsync<SimpleModel>();
        ...
        public async Task PostProtobufAsync_SimpleObject()
        {
            ...
            var result = await new Url("https://some.url").PostProtobufAsync(obj);
        ...
        public async Task PutProtobufAsync_SimpleObject()
        {
            ...
            var result = await new Url("https://some.url").PutProtobufAsync(obj);
        ...
        public async Task SendProtobufAsync_Get_SimpleObject()
        {
            ...
            var result = await new Url("https://some.url").SendProtobufAsync(HttpMethod.Get, null);
        ...
        public void PostProtobufAsync_WithoutProtocontract()
        {
            ...
            Assert.ThrowsAsync<InvalidOperationException>(() => new Url("https://some.url").PostProtobufAsync(obj));
        ...
        public async Task GetProtobufAsync_ComplexObject()
        {
            ...
            var result = await new Url("https://some.url").GetProtobufAsync<ComplexObject>();
